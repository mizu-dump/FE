...
if game.Players.LocalPlayer.Character:FindFirstChild("Accessory (Classic Sword)") then
  game.Players.LocalPlayer.Character["Accessory (Classic Sword)"].Handle.AccessoryWeld:Destroy()
  AlignCharacter(game.Players.LocalPlayer.Character["Accessory (Classic Sword)"].Handle, game.Players.LocalPlayer.Character.Model.Part, Vector3.new(0, 0, 0), Vector3.new(0, -80, 30))
  for index, asset in pairs(game.Players.LocalPlayer.Character.Model:GetChildren()) do
	...
	sendNotification("Moon Convert", "It is recommended to wear the hats used for this script... You can get the hats by using \"get hats;neptunian v\"", 7)
end
