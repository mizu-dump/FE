...
if not isfile("ScriptBase/Through Patches Violet.mp3") then
	writefile("ScriptBase/Through Patches Violet.mp3", game:HttpGet("https://github.com/mizu-dump/FE/raw/refs/heads/main/Music/Through%20Patches%20Of%20Violet.mp3", true))
end
...
print("> Running Neptunian Shedsky by @theycallmemiz")
...
kan.Pitch = 1.01
kan.SoundId = getcustomasset("ScriptBase/Through Patches Violet.mp3") --525289865,1873219898,381991270
kan.Name = "nepnepnep"
kan.Looped = true
kan:Play()
...
-- keywords that identify classic swords
local keywords = {
    "shedletssky",
    "sword",
    "classicsword",
...
local sword = findShedSword()

if sword and sword:FindFirstChild("Handle") then
    -- destroy weld
    if sword.Handle:FindFirstChild("AccessoryWeld") then
